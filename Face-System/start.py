...
def main():
    ...
    zipped_file = '/home/weber/Projects/BRAIN/spacialmapping/algorithmsStudy/Face-Recognition/database/database_embeddings.zip'
...
def init(
    ...
    database_embeddings_path = os.path.join(db_path, "database_embeddings.zip")
